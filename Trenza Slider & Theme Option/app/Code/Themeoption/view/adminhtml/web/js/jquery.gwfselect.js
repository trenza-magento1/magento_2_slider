...
require(['jquery', 'jquery/ui'], function($){
    function addGoogleFont(FontName) {
        ...
        googlefont = FontName.replace(/,/g,'|');
        ///if(jQuery('#googlefont').length){
        $("head").append("<link id='googlefont' href='https://fonts.googleapis.com/css?family=" + googlefont + "' rel='stylesheet' type='text/css'>");
        //}else{
    ...
    (function ($) {
        ...
        var fontFetch = (function () {
            var fontURL = 'https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyBxpEHblzC_AhCwCT9zSoaA1S8lf08JkyM ',
                callbacks = [],
                fetching = false;
            var fetch = function () {
        ...
        $.widget('mlg.gwfselect', {
            ...
            _loadFonts: function (fontArray) {
                ...
                addGoogleFont(fontArray); // for example
