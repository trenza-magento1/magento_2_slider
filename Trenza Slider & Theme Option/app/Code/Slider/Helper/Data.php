 ...
 * Slider data helper
 */
namespace Trenza\Slider\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Path to store config where count of days while slider is still recently added is stored
     *
     * @var string
     */
    const XML_PATH_DAYS_DIFFERENCE    = 'slider/view/days_difference';
    ...
    /**
     * Checks whether slider can be displayed in the frontend
     * @return boolean
     */
    ...
    /**
     * Return difference in days while slider is recently added
     * @return int
     */
     ...
     *
     * @param Trenza_Slider_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Trenza\Slider\Model\Slider $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
